...
#if defined( _LINUX ) || defined( _OSX ) || defined(PLATFORM_BSD) || defined(__EMSCRIPTEN__)
#define USE_INTRINSIC_INTERLOCKED
...
#if defined(WIN32) || defined(OSX) ||  defined( _PS3 ) || ( defined (_LINUX) ) || defined(PLATFORM_BSD) || defined(__EMSCRIPTEN__)
